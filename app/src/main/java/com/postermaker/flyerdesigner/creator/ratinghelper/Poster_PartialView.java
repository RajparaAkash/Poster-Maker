...
public class Poster_PartialView extends RelativeLayout {

    private ImageView mFilledView;
    private ImageView mEmptyView;

    public Poster_PartialView(Context context) {
        super(context);
        init();
    }

    public Poster_PartialView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public Poster_PartialView(Context context, AttributeSet attrs, int defStyleAttr) {
